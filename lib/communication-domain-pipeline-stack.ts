 ...
 * 
 * Self-contained pipeline infrastructure for the communication-domain domain:
...
export interface CommunicationDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class CommunicationDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: CommunicationDomainPipelineStackProps) {
