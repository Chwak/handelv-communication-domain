...
export class GetMessagesLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: GetMessagesLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/communication/get-messages/get-messages-lambda.ts')
    this.function = new NodejsFunction(this, 'GetMessagesFunction', {
