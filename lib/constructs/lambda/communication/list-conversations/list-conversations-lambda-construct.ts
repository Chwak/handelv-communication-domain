...
export class ListConversationsLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ListConversationsLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/communication/list-conversations/list-conversations-lambda.ts')
    this.function = new NodejsFunction(this, 'ListConversationsFunction', {
